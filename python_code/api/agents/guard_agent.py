...
class GuardAgent():
    ...
    def get_response(self,messages):
        ...
        # print("Input to chatbot:", input_messages)  # Debugging line
    ...
    def postprocess(self,output):
        # print("Raw output from chatbot:", output)  # Debugging line
        output = json.loads(output)
        # print("Json output from chatbot:", output)  # Debugging line
        dict_output = {
            "role": "assistant",
